  ...
  return (
    <div className="app">
      ...
      <div className="completed-task-container">
        ...
        {openSection.completedTasks && <CompletedTaskList deleteTask={deleteTask} completedTasks={completedTasks} />}
      </div>
      <Footer />
    </div>
  )
...
function Footer() {
  return (
    <footer className="footer">
      <p>Technologies and React concepts used: React, JSX, props, useState, component composition, conditional rendering, array methods (map, filter), event handling.</p>
    </footer>
  )
}
